...
public class RunPtEventHandler {
    ...
    public static void main(String[] args) {
        ...
        new MatsimEventsReader(manager).readFile(Paths.get("G:\\Users\\Janek\\Projects\\matsim-example-project\\output\\pt-tutorial\\ITERS\\it.50\\50.events.xml.gz").toString());
